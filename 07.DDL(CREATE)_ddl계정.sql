     ...
     * 제약조건(CONSTRAINTS)
        ...
        - 데이터 무결성 보장을 목적으로 한다\
          ...
          2) 참조 무결성 제약 조건 : FOREIGN KEY(외래키) 조건 위배
            가져오는 칼럼의 프라이머리 키가 지정되어 있을 경우 안써줘도 된다.
...
--   COMMENT ON COLUMN 테이블명.컬럼명 IS '주석내용';
COMMENT ON COLUMN TB_PUBLISHER.PUB_NO IS 'PUBLISHER_PK';
COMMENT ON COLUMN TB_PUBLISHER.PUB_NAME IS 'PUBLISHER_NN';


INSERT INTO TB_PUBLISHER VALUES (1,'더좋은 출판사','031-112-1131');
INSERT INTO TB_PUBLISHER VALUES (2,'더나은 출판사','031-122-2131');
INSERT INTO TB_PUBLISHER VALUES (3,'더화난 출판사','031-132-3131');
...
COMMENT  ON COLUMN TB_BOOK.BK_NO IS 'BOOK_PK';
COMMENT  ON COLUMN TB_BOOK.BK_TITLE IS 'BOOK_NN_TITLE';
COMMENT  ON COLUMN TB_BOOK.BK_AUTHOR IS 'BOOK_NN_AUTHOR';
COMMENT  ON COLUMN TB_BOOK.BK_PUB_NO IS 'BOOK_FK';

INSERT INTO TB_BOOK VALUES (1,'어린왕자','베르나르',13000,1);
INSERT INTO TB_BOOK VALUES (2,'신','베르베르',20000,1);
INSERT INTO TB_BOOK VALUES (3,'서유기','베나',30000,1);
INSERT INTO TB_BOOK VALUES (4,'신서유기','나르',21000,1);
INSERT INTO TB_BOOK VALUES (5,'빨강머리 앤','모히',53000,1);
...
3. 회원에 대한 데이터를 담기위한 회원 테이블 (TB_MEMBER)
   ...
   - 5개 정도의 샘플 데이터 추가하기
*/
INSERT INTO TB_BOOK VALUES (32,'RRR','1111','HELLO','M', '강원도 인제군 인제읍 ','010-1241-1234',DEFAULT,DEFAULT);
...
COMMENT  ON COLUMN TB_MEMBER.MEMBER_NO IS 'MEMBER_PK';
COMMENT  ON COLUMN TB_MEMBER.MEMBER_ID IS 'MEMBER_UQ';
COMMENT  ON COLUMN TB_MEMBER.MEMBER_PWD IS 'MEMBER_NN_PWD';
COMMENT  ON COLUMN TB_MEMBER.MEMBER_NAME IS 'MEMBER_NN_NAME';
COMMENT  ON COLUMN TB_MEMBER.GENDER IS 'MEMBER_CK_GEN';
COMMENT  ON COLUMN TB_MEMBER.STATUS IS 'MEMBER_CK_STA';
COMMENT  ON COLUMN TB_MEMBER.ENROLL_DATE IS 'MEMBER_NN_EN';


INSERT INTO TB_MEMBER VALUES (32,'RRR','1111','HELLO1','M', '강원도 인제군 인제읍 ','010-1241-1234',DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES (33,'AA','1111','HELLO2','M', '강원도 인제군 인제읍 ','010-2241-1234',DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES (34,'BB','1111','HELLO3','M', '강원도 인제군 인제읍 ','010-3241-1234',DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES (35,'CCC','1111','HELLO4','M', '강원도 인제군 인제읍 ','010-4241-1234',DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES (36,'DDD','1111','HELLO5','M', '강원도 인제군 인제읍 ','010-5241-1234',DEFAULT,DEFAULT);
...
COMMENT  ON COLUMN TB_RENT.RENT_NO IS 'RENT_PK';
COMMENT  ON COLUMN TB_RENT.RENT_MEM_NO IS 'RENT_FK_MEM';
COMMENT  ON COLUMN TB_RENT.RENT_BOOK_NO IS 'RENT_FK_BOOK';

INSERT INTO TB_RENT VALUES (132,32,1 ,SYSDATE);
INSERT INTO TB_RENT VALUES (133,33,2 ,SYSDATE);
INSERT INTO TB_RENT VALUES (134,34,3 ,SYSDATE);
