...
/*
    ...
    [INCREMENT BY 숫자]             --> 몇씩 증가시킬 것인지 지정(기본값 1)
    ...
    * 캐시메모리 : 미리 발생될 값들을 생성 해서 저장해두는 공간
...
/*
    ...
    시퀀스명.NEXTVAL : 시퀀스값에 일정한 값을 증가 
                                현재 시퀀스 값에서 INCREMENT BY 값 만큼 증가한 값
                                == 시퀀스명.CURRVAL + INCREMENT BY 값
*/
SELECT SEQ_EMPNO.CURRVAL FROM DAUL;
-- NEXTVAL 를 단 한번도 수행하지 않은 이상 CURRVAL 할수 없음
...
VALUES( SEQ_EID.NEXTVAL, '우재남', '980226-1111111' , 'J1' , SYSDATE);
